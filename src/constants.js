...
// Codex account configuration (separate file)
export const CODEX_ACCOUNT_CONFIG_PATH = config?.codexAccountConfigPath || join(
    cwd(),
    'codex-accounts.json'
);
...
export const CODEX_OAUTH_EXTRA_PARAMS = {
...
// Codex models list (from 9router)
 ...
 * @returns {'claude' | 'gemini' | 'codex' | 'unknown'} The model family
 */
